<footer class="">
	<ul class="icons">
		...
		<li><a href="mailto:typo@theintermittentgeek.com" class="fa-envelope"><span class="label">Email</span></a></li>
	</ul>

	<p class="copyright">&copy; 2016 The Intermittent Geek | All Rights Reserved</p>
</footer>